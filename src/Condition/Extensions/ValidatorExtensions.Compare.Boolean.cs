...
namespace Verbess.Utils.Conditions
{
    ...
    public static partial class ValidatorExtensions
    {
        ...
        public static Validator<bool> IsTrue(this Validator<bool> validator)
        {
            if (!validator.Value)
            {
                Throw.ValueShouldBeTrue<bool>(validator, null);
            }
        ...
        public static Validator<bool> IsTrue(this Validator<bool> validator, string conditionDescription)
        {
            if (!validator.Value)
            {
                Throw.ValueShouldBeTrue<bool>(validator, conditionDescription);
            }
        ...
        public static Validator<Nullable<bool>> IsTrue(this Validator<Nullable<bool>> validator)
        {
            ...
            {
                Throw.ValueShouldBeTrue<Nullable<bool>>(validator, null);
            }
        ...
        /// <exception cref="ArgumentException">Thrown when the <see cref="Validator{T}.Value">Value</see> of the specified <paramref name="validator"/> is <b>false</b> or null, while the specified <paramref name="validator"/> is created using the <see cref="Condition.Requires{T}(T,string)">Requires</see> extension method.</exception>
        /// <exception cref="PostconditionException">Thrown when the <see cref="Validator{T}.Value">Value</see> of the specified <paramref name="validator"/> is <b>false</b> or null, while the specified <paramref name="validator"/> is created using the <see cref="Condition.Ensures{T}(T,string)">Ensures</see> extension method.</exception>
        public static Validator<Nullable<bool>> IsTrue(this Validator<Nullable<bool>> validator, string conditionDescription)
        {
            if (!(validator.Value == true))
            {
                Throw.ValueShouldBeTrue<Nullable<bool>>(validator, conditionDescription);
            }
        ...
        public static Validator<bool> IsFalse(this Validator<bool> validator)
        {
            if (validator.Value)
            {
                Throw.ValueShouldBeFalse<bool>(validator, null);
            }
            ...
            string conditionDescription)
        {
            if (validator.Value)
            {
                Throw.ValueShouldBeFalse<bool>(validator, conditionDescription);
            }
        ...
        public static Validator<Nullable<bool>> IsFalse(this Validator<Nullable<bool>> validator)
        {
            ...
            {
                Throw.ValueShouldBeFalse<Nullable<bool>>(validator, null);
            }
            ...
            string conditionDescription)
        {
            if (!(validator.Value == false))
            {
                Throw.ValueShouldBeFalse<Nullable<bool>>(validator, conditionDescription);
            }
